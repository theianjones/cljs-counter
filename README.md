...
* [`src/cljs/simple/`](src/cljs/simple/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/simple/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `simple` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/simple/config.cljs) defaults to `true` in
...
```clj
(ns simple.example
  (:require [simple.config :as config])
